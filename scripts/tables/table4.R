...
p_explor<- xlsx::read.xlsx("data/transfers/p_explore.xls",sheetIndex=1, header=TRUE, encoding = "UTF-8")
names(p_explor)<- c("ID", "Ep11", "Ep12", "Ep13", "Ep21", "Ep22", "Ep23", "Ep31", "Ep32", "Ep33")


p_search<-xlsx::read.xlsx("data/transfers/p_search.xls",sheetIndex=1, header=TRUE, encoding = "UTF-8")
names(p_search)<- c("ID", "Sp11", "Sp12", "Sp13", "Sp21", "Sp22", "Sp23", "Sp31", "Sp32", "Sp33")


p_purchase<- xlsx::read.xlsx("data/transfers/p_purchase.xls",sheetIndex=1, header=TRUE, encoding = "UTF-8")
names(p_purchase)<- c("ID", "Pup11", "Pup12", "Pup13", "Pup21", "Pup22", "Pup23", "Pup31", "Pup32", "Pup33")


p_post<-xlsx::read.xlsx("data/transfers/p_post.xls",sheetIndex=1, header=TRUE, encoding = "UTF-8")
...
###################### MODELO PARA LAS TRANSICIONES ZONA 1 ###############
##########################################################
